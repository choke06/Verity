...
You can think of it like randomly moving through the network: from a source to the claims it asserts, then from those claims to other supporting sources, over and over again. Sources and claims that the process keeps revisiting become more credible over time.
