...
The mission is to make the Verity credibility inference engine accessible to AI systems through an open-source [Model Context Protocol (MCP)](https://modelcontextprotocol.io) server to allow them to seamlessly incorporate credibility inference directly into their reasoning process.
